# Playbook: web-resource · WR - MPPP - SVG - Por digitar

Inventario 12.1. El contenido NO va en este playbook: vive en
`recursos/svg/pordigitar.svg`, se edita y se revisa como un archivo, y la herramienta lo sube.
...
```json
{
  ...
  "descripcion": "Entrada de sitemap Por digitar (Ejecutivo).",
  "recurso": "SVG",
