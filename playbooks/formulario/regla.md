...
```json
{
  ...
  "solo_lectura": false,
  "descripcion": "Formulario principal de Regla. Lo edita el Administrador tecnico; el step de integridad valida al guardar.",
  "pestana": "General",
  "encabezado": [
    "sanic_nombre",
    "sanic_codigo",
